...
Your agent will clone the repo, read the 7 skill files, register them with `openclaw skills install`, and set up 6 internal cron jobs for autonomous routines. One message, everything handled.
